...
public class GildedNetheriteArmor extends ArmorItem {
    public GildedNetheriteArmor(Holder<ArmorMaterial> material, Type slot, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipList, TooltipFlag flag) {
        if (ClientConfig.ItemTooltips.getValue()) {
            tooltipList.add(Component.translatable("tooltip.gildednetherite.gilded_netherite_armor").withStyle(ChatFormatting.BLUE));
        }
    }
}